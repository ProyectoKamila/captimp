...
<div class="container carousel-desca">
    <div class="row">
                     <?php query_posts(array('post_type'=>'descargas','posts_per_page'=>30)); ?>
                     ...
                     <?php
                        ...
                        $nombre_archivo = $rr[$f];
                      ?>
                        <div class="borde-pla col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center sin-padding">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 sin-padding">
                            ...
                            <?php } ?>
                            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 sin-padding">
                                <div class="col-xs-12 sin-padding">
